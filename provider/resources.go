...
import (
	...
	"github.com/HighTideCRM/pulumi-frontegg/provider/pkg/version"
)
...
//go:embed cmd/pulumi-resource-frontegg/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-frontegg/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-frontegg/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "frontegg", frontegg.Provider(),
		...
		// convention is to have a function at "github.com/frontegg/terraform-provider-frontegg/provider".New
		...
		Keywords:   []string{"frontegg", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.frontegg.com",
		Repository: "https://github.com/HighTideCRM/pulumi-frontegg",
		...
		JavaScript: &tfbridge.JavaScriptInfo{
			PackageName: "@hightide-crm/pulumi-frontegg",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/HighTideCRM/pulumi-frontegg/sdk/",
