...
export class Tenant extends pulumi.CustomResource {
     ...
     */
    public readonly applicationUri!: pulumi.Output<string | undefined>;
    /**
    ...
    public readonly selectedMetadata!: pulumi.Output<{[key: string]: string} | undefined>;
    ...
    constructor(name: string, argsOrState?: TenantArgs | TenantState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["selectedMetadata"] = state ? state.selectedMetadata : undefined;
        } else {
            ...
            resourceInputs["selectedMetadata"] = args ? args.selectedMetadata : undefined;
        }
...
export interface TenantState {
    ...
    selectedMetadata?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
}
