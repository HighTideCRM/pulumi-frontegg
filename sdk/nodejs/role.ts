...
export class Role extends pulumi.CustomResource {
     ...
     */
    public readonly firstUser!: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RoleArgs | RoleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["firstUser"] = state ? state.firstUser : undefined;
            ...
            resourceInputs["firstUser"] = args ? args.firstUser : undefined;
...
export interface RoleState {
     ...
     * Whether the role should be applied to the first user in the tenant (new tenants only).
     */
    firstUser?: pulumi.Input<boolean>;
    /**
     * A human-readable identifier for the role.
     */
