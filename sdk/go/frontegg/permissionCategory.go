...
// The timestamp at which the permission category was created.
func (o PermissionCategoryOutput) CreatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v *PermissionCategory) pulumi.StringOutput { return v.CreatedAt }).(pulumi.StringOutput)
}

// A human-readable description of the permission category.
func (o PermissionCategoryOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *PermissionCategory) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}

// A human-readable name for the permission category.
func (o PermissionCategoryOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *PermissionCategory) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
