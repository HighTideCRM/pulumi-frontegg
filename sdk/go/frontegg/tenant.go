...
import (
	...
	"errors"
	"github.com/HighTideCRM/pulumi-frontegg/sdk/go/frontegg/internal"
...
type Tenant struct {
	...
	ApplicationUri pulumi.StringPtrOutput `pulumi:"applicationUri"`
	// A human-readable identifier for the tenant.
	Key pulumi.StringOutput `pulumi:"key"`
	// A human-readable name for the tenant.
	Name             pulumi.StringOutput    `pulumi:"name"`
	SelectedMetadata pulumi.StringMapOutput `pulumi:"selectedMetadata"`
}
...
type tenantState struct {
	...
	SelectedMetadata map[string]string `pulumi:"selectedMetadata"`
}
...
type TenantState struct {
	...
	SelectedMetadata pulumi.StringMapInput
}
...
// The application URI for this tenant.
func (o TenantOutput) ApplicationUri() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Tenant) pulumi.StringPtrOutput { return v.ApplicationUri }).(pulumi.StringPtrOutput)
}

// A human-readable identifier for the tenant.
func (o TenantOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v *Tenant) pulumi.StringOutput { return v.Key }).(pulumi.StringOutput)
}
...
func (o TenantOutput) SelectedMetadata() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Tenant) pulumi.StringMapOutput { return v.SelectedMetadata }).(pulumi.StringMapOutput)
}
