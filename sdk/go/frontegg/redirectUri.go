...
// The redirect URI key.
func (o RedirectUriOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v *RedirectUri) pulumi.StringOutput { return v.Key }).(pulumi.StringOutput)
}

// The redirect URI.
func (o RedirectUriOutput) RedirectUri() pulumi.StringOutput {
	return o.ApplyT(func(v *RedirectUri) pulumi.StringOutput { return v.RedirectUri }).(pulumi.StringOutput)
}
