...
// The identifier of the category to which this permission belongs.
func (o PermissionOutput) CategoryId() pulumi.StringOutput {
	return o.ApplyT(func(v *Permission) pulumi.StringOutput { return v.CategoryId }).(pulumi.StringOutput)
}

// The timestamp at which the permission was created.
func (o PermissionOutput) CreatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v *Permission) pulumi.StringOutput { return v.CreatedAt }).(pulumi.StringOutput)
}
...
// A human-readable identifier for the permission.
func (o PermissionOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v *Permission) pulumi.StringOutput { return v.Key }).(pulumi.StringOutput)
}
