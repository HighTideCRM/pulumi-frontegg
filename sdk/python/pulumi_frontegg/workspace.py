...
class Workspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 admin_portal: Optional[pulumi.Input[Union['WorkspaceAdminPortalArgs', 'WorkspaceAdminPortalArgsDict']]] = None,
                 allowed_origins: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 auth_policy: Optional[pulumi.Input[Union['WorkspaceAuthPolicyArgs', 'WorkspaceAuthPolicyArgsDict']]] = None,
                 backend_stack: Optional[pulumi.Input[str]] = None,
                 bot_detection_email: Optional[pulumi.Input[Union['WorkspaceBotDetectionEmailArgs', 'WorkspaceBotDetectionEmailArgsDict']]] = None,
                 brute_force_protection_email: Optional[pulumi.Input[Union['WorkspaceBruteForceProtectionEmailArgs', 'WorkspaceBruteForceProtectionEmailArgsDict']]] = None,
                 bulk_tenants_invites_email: Optional[pulumi.Input[Union['WorkspaceBulkTenantsInvitesEmailArgs', 'WorkspaceBulkTenantsInvitesEmailArgsDict']]] = None,
                 captcha_policy: Optional[pulumi.Input[Union['WorkspaceCaptchaPolicyArgs', 'WorkspaceCaptchaPolicyArgsDict']]] = None,
                 country: Optional[pulumi.Input[str]] = None,
                 custom_domains: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 email_verification_email: Optional[pulumi.Input[Union['WorkspaceEmailVerificationEmailArgs', 'WorkspaceEmailVerificationEmailArgsDict']]] = None,
                 facebook_social_login: Optional[pulumi.Input[Union['WorkspaceFacebookSocialLoginArgs', 'WorkspaceFacebookSocialLoginArgsDict']]] = None,
                 frontegg_domain: Optional[pulumi.Input[str]] = None,
                 frontend_stack: Optional[pulumi.Input[str]] = None,
                 github_social_login: Optional[pulumi.Input[Union['WorkspaceGithubSocialLoginArgs', 'WorkspaceGithubSocialLoginArgsDict']]] = None,
                 google_social_login: Optional[pulumi.Input[Union['WorkspaceGoogleSocialLoginArgs', 'WorkspaceGoogleSocialLoginArgsDict']]] = None,
                 hosted_login: Optional[pulumi.Input[Union['WorkspaceHostedLoginArgs', 'WorkspaceHostedLoginArgsDict']]] = None,
                 impossible_travel_email: Optional[pulumi.Input[Union['WorkspaceImpossibleTravelEmailArgs', 'WorkspaceImpossibleTravelEmailArgsDict']]] = None,
                 lockout_policy: Optional[pulumi.Input[Union['WorkspaceLockoutPolicyArgs', 'WorkspaceLockoutPolicyArgsDict']]] = None,
                 magic_code_email: Optional[pulumi.Input[Union['WorkspaceMagicCodeEmailArgs', 'WorkspaceMagicCodeEmailArgsDict']]] = None,
                 magic_link_email: Optional[pulumi.Input[Union['WorkspaceMagicLinkEmailArgs', 'WorkspaceMagicLinkEmailArgsDict']]] = None,
                 mfa_authentication_app: Optional[pulumi.Input[Union['WorkspaceMfaAuthenticationAppArgs', 'WorkspaceMfaAuthenticationAppArgsDict']]] = None,
                 mfa_enroll_email: Optional[pulumi.Input[Union['WorkspaceMfaEnrollEmailArgs', 'WorkspaceMfaEnrollEmailArgsDict']]] = None,
                 mfa_otc_email: Optional[pulumi.Input[Union['WorkspaceMfaOtcEmailArgs', 'WorkspaceMfaOtcEmailArgsDict']]] = None,
                 mfa_policy: Optional[pulumi.Input[Union['WorkspaceMfaPolicyArgs', 'WorkspaceMfaPolicyArgsDict']]] = None,
                 mfa_recovery_code_email: Optional[pulumi.Input[Union['WorkspaceMfaRecoveryCodeEmailArgs', 'WorkspaceMfaRecoveryCodeEmailArgsDict']]] = None,
                 mfa_unenroll_email: Optional[pulumi.Input[Union['WorkspaceMfaUnenrollEmailArgs', 'WorkspaceMfaUnenrollEmailArgsDict']]] = None,
                 microsoft_social_login: Optional[pulumi.Input[Union['WorkspaceMicrosoftSocialLoginArgs', 'WorkspaceMicrosoftSocialLoginArgsDict']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 new_device_connected_email: Optional[pulumi.Input[Union['WorkspaceNewDeviceConnectedEmailArgs', 'WorkspaceNewDeviceConnectedEmailArgsDict']]] = None,
                 new_mfa_method_email: Optional[pulumi.Input[Union['WorkspaceNewMfaMethodEmailArgs', 'WorkspaceNewMfaMethodEmailArgsDict']]] = None,
                 oidc: Optional[pulumi.Input[Union['WorkspaceOidcArgs', 'WorkspaceOidcArgsDict']]] = None,
                 open_saas_installed: Optional[pulumi.Input[bool]] = None,
                 password_policy: Optional[pulumi.Input[Union['WorkspacePasswordPolicyArgs', 'WorkspacePasswordPolicyArgsDict']]] = None,
                 pwned_password_email: Optional[pulumi.Input[Union['WorkspacePwnedPasswordEmailArgs', 'WorkspacePwnedPasswordEmailArgsDict']]] = None,
                 remove_mfa_method_email: Optional[pulumi.Input[Union['WorkspaceRemoveMfaMethodEmailArgs', 'WorkspaceRemoveMfaMethodEmailArgsDict']]] = None,
                 reset_password_email: Optional[pulumi.Input[Union['WorkspaceResetPasswordEmailArgs', 'WorkspaceResetPasswordEmailArgsDict']]] = None,
                 reset_phone_number_email: Optional[pulumi.Input[Union['WorkspaceResetPhoneNumberEmailArgs', 'WorkspaceResetPhoneNumberEmailArgsDict']]] = None,
                 saml: Optional[pulumi.Input[Union['WorkspaceSamlArgs', 'WorkspaceSamlArgsDict']]] = None,
                 sms_authentication_enabled_email: Optional[pulumi.Input[Union['WorkspaceSmsAuthenticationEnabledEmailArgs', 'WorkspaceSmsAuthenticationEnabledEmailArgsDict']]] = None,
                 sso_domain_policy: Optional[pulumi.Input[Union['WorkspaceSsoDomainPolicyArgs', 'WorkspaceSsoDomainPolicyArgsDict']]] = None,
                 sso_multi_tenant_policy: Optional[pulumi.Input[Union['WorkspaceSsoMultiTenantPolicyArgs', 'WorkspaceSsoMultiTenantPolicyArgsDict']]] = None,
                 suspicious_ip_email: Optional[pulumi.Input[Union['WorkspaceSuspiciousIpEmailArgs', 'WorkspaceSuspiciousIpEmailArgsDict']]] = None,
                 user_activation_email: Optional[pulumi.Input[Union['WorkspaceUserActivationEmailArgs', 'WorkspaceUserActivationEmailArgsDict']]] = None,
                 user_invitation_email: Optional[pulumi.Input[Union['WorkspaceUserInvitationEmailArgs', 'WorkspaceUserInvitationEmailArgsDict']]] = None,
                 user_used_invitation_email: Optional[pulumi.Input[Union['WorkspaceUserUsedInvitationEmailArgs', 'WorkspaceUserUsedInvitationEmailArgsDict']]] = None,
                 __props__=None):
        """
        Create a Workspace resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Union['WorkspaceAdminPortalArgs', 'WorkspaceAdminPortalArgsDict']] admin_portal: Configures the admin portal.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] allowed_origins: The origins that are allowed to access the workspace. This parameter controls the value of the "Origin" header for API
               responses.
        :param pulumi.Input[Union['WorkspaceAuthPolicyArgs', 'WorkspaceAuthPolicyArgsDict']] auth_policy: Configures the general authentication policy.
        :param pulumi.Input[str] backend_stack: The backend stack of the application associated with the workspace.
        :param pulumi.Input[Union['WorkspaceBotDetectionEmailArgs', 'WorkspaceBotDetectionEmailArgsDict']] bot_detection_email: Configures the bot detection email.
        :param pulumi.Input[Union['WorkspaceBruteForceProtectionEmailArgs', 'WorkspaceBruteForceProtectionEmailArgsDict']] brute_force_protection_email: Configures the brute force protection email.
        :param pulumi.Input[Union['WorkspaceBulkTenantsInvitesEmailArgs', 'WorkspaceBulkTenantsInvitesEmailArgsDict']] bulk_tenants_invites_email: Configures the bulk tenants invite email.
        :param pulumi.Input[Union['WorkspaceCaptchaPolicyArgs', 'WorkspaceCaptchaPolicyArgsDict']] captcha_policy: Configures the CAPTCHA policy in the signup form.
        :param pulumi.Input[str] country: The country associated with the workspace.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] custom_domains: List of custom domains at which Frontegg services will be reachable. You must configure CNAME for each domain, you can
               get record values from the portal.
        :param pulumi.Input[Union['WorkspaceEmailVerificationEmailArgs', 'WorkspaceEmailVerificationEmailArgsDict']] email_verification_email: Configures the verification email.
        :param pulumi.Input[Union['WorkspaceFacebookSocialLoginArgs', 'WorkspaceFacebookSocialLoginArgsDict']] facebook_social_login: Configures social login with Facebook.
        :param pulumi.Input[str] frontegg_domain: The domain at which the Frontegg API is served for this workspace. The domain must end with ".frontegg.com" or
               ".us.frontegg.com".
        :param pulumi.Input[str] frontend_stack: The frontend stack of the application associated with the worksapce.
        :param pulumi.Input[Union['WorkspaceGithubSocialLoginArgs', 'WorkspaceGithubSocialLoginArgsDict']] github_social_login: Configures social login with GitHub.
        :param pulumi.Input[Union['WorkspaceGoogleSocialLoginArgs', 'WorkspaceGoogleSocialLoginArgsDict']] google_social_login: Configures social login with Google.
        :param pulumi.Input[Union['WorkspaceHostedLoginArgs', 'WorkspaceHostedLoginArgsDict']] hosted_login: Configures Frontegg-hosted OAuth login.
        :param pulumi.Input[Union['WorkspaceImpossibleTravelEmailArgs', 'WorkspaceImpossibleTravelEmailArgsDict']] impossible_travel_email: Configures the impossible travel email.
        :param pulumi.Input[Union['WorkspaceLockoutPolicyArgs', 'WorkspaceLockoutPolicyArgsDict']] lockout_policy: Configures the user lockout policy.
        :param pulumi.Input[Union['WorkspaceMagicCodeEmailArgs', 'WorkspaceMagicCodeEmailArgsDict']] magic_code_email: Configures the one time code email.
        :param pulumi.Input[Union['WorkspaceMagicLinkEmailArgs', 'WorkspaceMagicLinkEmailArgsDict']] magic_link_email: Configures the magic link email.
        :param pulumi.Input[Union['WorkspaceMfaAuthenticationAppArgs', 'WorkspaceMfaAuthenticationAppArgsDict']] mfa_authentication_app: Configures the multi-factor authentication (MFA) via an authentication app.
        :param pulumi.Input[Union['WorkspaceMfaEnrollEmailArgs', 'WorkspaceMfaEnrollEmailArgsDict']] mfa_enroll_email: Configures the MFA enroll email.
        :param pulumi.Input[Union['WorkspaceMfaOtcEmailArgs', 'WorkspaceMfaOtcEmailArgsDict']] mfa_otc_email: Configures the account challenge with code email.
        :param pulumi.Input[Union['WorkspaceMfaPolicyArgs', 'WorkspaceMfaPolicyArgsDict']] mfa_policy: Configures the multi-factor authentication (MFA) policy.
        :param pulumi.Input[Union['WorkspaceMfaRecoveryCodeEmailArgs', 'WorkspaceMfaRecoveryCodeEmailArgsDict']] mfa_recovery_code_email: Configures the MFA recovery code email.
        :param pulumi.Input[Union['WorkspaceMfaUnenrollEmailArgs', 'WorkspaceMfaUnenrollEmailArgsDict']] mfa_unenroll_email: Configures the MFA unenroll email.
        :param pulumi.Input[Union['WorkspaceMicrosoftSocialLoginArgs', 'WorkspaceMicrosoftSocialLoginArgsDict']] microsoft_social_login: Configures social login with Google.
        :param pulumi.Input[str] name: The name of the workspace.
        :param pulumi.Input[Union['WorkspaceNewDeviceConnectedEmailArgs', 'WorkspaceNewDeviceConnectedEmailArgsDict']] new_device_connected_email: Configures the new device connected email.
        :param pulumi.Input[Union['WorkspaceNewMfaMethodEmailArgs', 'WorkspaceNewMfaMethodEmailArgsDict']] new_mfa_method_email: Configures the new MFA method email.
        :param pulumi.Input[Union['WorkspaceOidcArgs', 'WorkspaceOidcArgsDict']] oidc: Configures SSO via OIDC.
        :param pulumi.Input[bool] open_saas_installed: Whether the application associated with the workspace has OpenSaaS installed.
        :param pulumi.Input[Union['WorkspacePasswordPolicyArgs', 'WorkspacePasswordPolicyArgsDict']] password_policy: Configures the password policy.
        :param pulumi.Input[Union['WorkspacePwnedPasswordEmailArgs', 'WorkspacePwnedPasswordEmailArgsDict']] pwned_password_email: Configures the pwned password email.
        :param pulumi.Input[Union['WorkspaceRemoveMfaMethodEmailArgs', 'WorkspaceRemoveMfaMethodEmailArgsDict']] remove_mfa_method_email: Configures the remove MFA method email.
        :param pulumi.Input[Union['WorkspaceResetPasswordEmailArgs', 'WorkspaceResetPasswordEmailArgsDict']] reset_password_email: Configures the password reset email.
        :param pulumi.Input[Union['WorkspaceResetPhoneNumberEmailArgs', 'WorkspaceResetPhoneNumberEmailArgsDict']] reset_phone_number_email: Configures the reset phone number email.
        :param pulumi.Input[Union['WorkspaceSamlArgs', 'WorkspaceSamlArgsDict']] saml: Configures SSO via SAML.
        :param pulumi.Input[Union['WorkspaceSmsAuthenticationEnabledEmailArgs', 'WorkspaceSmsAuthenticationEnabledEmailArgsDict']] sms_authentication_enabled_email: Configures the SMS authentication enabled email.
        :param pulumi.Input[Union['WorkspaceSsoDomainPolicyArgs', 'WorkspaceSsoDomainPolicyArgsDict']] sso_domain_policy: Configures how SSO domains are validated.
        :param pulumi.Input[Union['WorkspaceSsoMultiTenantPolicyArgs', 'WorkspaceSsoMultiTenantPolicyArgsDict']] sso_multi_tenant_policy: Configures how multiple tenants can claim the same SSO domain.
        :param pulumi.Input[Union['WorkspaceSuspiciousIpEmailArgs', 'WorkspaceSuspiciousIpEmailArgsDict']] suspicious_ip_email: Configures the suspicious IP email.
        :param pulumi.Input[Union['WorkspaceUserActivationEmailArgs', 'WorkspaceUserActivationEmailArgsDict']] user_activation_email: Configures the user activation email.
        :param pulumi.Input[Union['WorkspaceUserInvitationEmailArgs', 'WorkspaceUserInvitationEmailArgsDict']] user_invitation_email: Configures the user invitation email.
        :param pulumi.Input[Union['WorkspaceUserUsedInvitationEmailArgs', 'WorkspaceUserUsedInvitationEmailArgsDict']] user_used_invitation_email: Configures the user used invitation email.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            user_activation_email: Optional[pulumi.Input[Union['WorkspaceUserActivationEmailArgs', 'WorkspaceUserActivationEmailArgsDict']]] = None,
            user_invitation_email: Optional[pulumi.Input[Union['WorkspaceUserInvitationEmailArgs', 'WorkspaceUserInvitationEmailArgsDict']]] = None,
            user_used_invitation_email: Optional[pulumi.Input[Union['WorkspaceUserUsedInvitationEmailArgs', 'WorkspaceUserUsedInvitationEmailArgsDict']]] = None) -> 'Workspace':
        """
